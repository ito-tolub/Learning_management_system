      ...
      <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36 flex-grow'>
        ...
        <div className='text-gray-800'>
                        ...
                        <li key={i} className='flex items-start gap-3'>
                          ...
                          <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                            ...
                            <div className='flex gap-2'>
                              ...
                              onClick={()=> setPlayerData({...lecture, chapter: index + 1, lecture : i + 1})} className='text-blue-500 hover:underline cursor-pointer'>Watch</p>}
          ...
          <div className='flex items-center gap-2 py-3 mt-10'>
              <h1 className='text-xl text-bold'>Rate thic Course : </h1>
