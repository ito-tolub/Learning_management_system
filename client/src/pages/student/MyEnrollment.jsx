...
const MyEnrollment = () => {
  ...
  const { enrolledCourses, calculateCourseDuration, navigate, userData, fetUserEnrolledCourses, backendUrl, getToken, calculateNoofLectures } = useContext(AppContext)
  ...
  return (
    <>
      <div className='md:px-36 px-8 pt-10'>
        <h1 className='text-2x1 font-semibold'>My Enrollment</h1>
        <table className='md:table-auto table-fixed w-full overflow-hidden border-mt-10'>
          <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left mas-sm:hidden'>
            <tr>
